...
const Footer = () => {
    return (
        <footer className="footer flex justify-between p-10 bg-black text-primary-content">
          
  <div>
  <div>
    <img className="w-10 h-10" src="hulk.png" alt="" />
    <p className="font-bold">
      My Avengers <br/>Providing children toy since 1995
    </p> 
